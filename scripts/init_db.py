...
async def create_tables():
    ...
    with Progress(
        ...
        connect_task = progress.add_task("[yellow]Connecting to database...", total=1, status="Starting")
    ...
    try:
        ...
        with Progress(
            ...
            tables_task = progress.add_task("[yellow]Creating tables...", total=table_count)
        ...
        if success_count == table_count:
            console.print(f"[bold green]✅ All {table_count} tables created successfully![/bold green]")
        else:
            console.print(f"[bold yellow]⚠️ Created {success_count} out of {table_count} tables[/bold yellow]")
        ...
        with Progress(
            ...
            indexes_task = progress.add_task("[yellow]Creating indexes...", total=index_count)
        ...
        if index_success_count == index_count:
            console.print(f"[bold green]✅ All {index_count} indexes created successfully![/bold green]")
        else:
            console.print(f"[bold yellow]⚠️ Created {index_success_count} out of {index_count} indexes[/bold yellow]")
        ...
        with Progress(
            ...
            policies_task = progress.add_task("[yellow]Creating security policies...", total=policy_count)
        ...
        if policy_success_count == policy_count:
            console.print(f"[bold green]✅ All {policy_count} security policies created successfully![/bold green]")
        else:
            console.print(f"[bold yellow]⚠️ Created {policy_success_count} out of {policy_count} security policies[/bold yellow]")
